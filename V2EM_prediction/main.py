#for single video and audio, replace the file path in datasets.py
import os
import time
import torch
import numpy as np
...
from V2EM_prediction.src.datasets_news import get_dataset_iemocap, collate_fn
from V2EM_prediction.src.trainers.r_emotiontrainer_news import IemocapTrainer


import sys

def emotion_analysis(file_name):
    start = time.time()
    ...
    checkpoint = torch.load(
        "/data1/zyq/FV2ES-main/FV2ES/V2EM_prediction/savings/models/mme2e_tav_Acc_0.8477_F1_0.5857_AUC_0.8747_imginvl500_seed0.pt",
