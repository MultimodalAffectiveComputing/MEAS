...
def get_dataset_iemocap(id:int,base_path:str,data_folder: str, phase: str, img_interval: int, hand_crafted_features: Optional[bool] = False):
    # preprocessing of the origional dataset
    all_metas = {}

    #args
    avi_fname = f'{base_path}/video/{id}.avi'
    wav_fname = f'{base_path}/audio/{id}.wav'
    script_fname = f'{base_path}/script/{id}_script.csv'

    #args
    avi_fname = f'/home/datasets/dataset_marked_1/video/{id}.mp4'
    wav_fname = f'{base_path}/audio/{id}.wav'
    script_fname = f'{base_path}/script/{id}_script.csv'
